...
#     orchestrator.py               # runs demos/tests/visualizations for transformer_architecture
...
# NOTE ON IMPORTS
# ----------------
# All imports are LOCAL. Run from inside `transformer_architecture/`.
